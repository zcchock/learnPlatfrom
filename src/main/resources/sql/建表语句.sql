...
ADD constraint user_atc foreign key(user_id) references user(user_id);

ALTER TABLE user_article
ADD constraint user_atc2 foreign key(atc_id) references blog_atc(atc_id);

ALTER TABLE user_role
ADD constraint usr_role foreign key(user_id) references user(user_id);

ALTER TABLE user_role
ADD constraint usr_role2 foreign key(role_id) references role(role_id);
